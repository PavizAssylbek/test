      ...
      <div className={styles.sidebar_content}>
        ...
        </Link>
        {
          ...
          <div 
            ...
            className={clsx(styles.sidebar_link, styles.sidebar_btn)}
          >
            {
              vissible && (
                <div className={clsx(styles.sidebar_menu, 'border-radius')}>
                  <p>Киценко Артём</p>
                  <Link href="/">
                    <a>Профиль</a>
                  </Link>
                  ...
                  <Link href="/feedback">
                    <a className={styles.sidebar_feedback}>Обратная связь <sup>2</sup></a>
                  </Link>
                </div>
              )
            }
